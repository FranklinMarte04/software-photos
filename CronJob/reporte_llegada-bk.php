			...
			while($row=mysqli_fetch_array($consulta)){
             ...
             $row_llegada .= "
			     <tr>
                               ...
                               <td>".money_format('%i', $row['monto_total']) ."</td>
...
//$mailto = "".destinatio_reportenoche()."";
   $mailto ="avasquez@innovatechvs.com,avictoria@bavaroadventurepark.com,reservas@bavaroadventurepark.com,recepcion1@bavaroadventurepark.com,cmmercado@bavaroadventurepark.com,directoroperaciones@bavaroadventurepark.com";
$mailsubj = "Reporte Llegadas";
$headers = "From: BAVAROADVENTUREPARK <avasquez@innovatechvs.com>\r\n"; 
$headers.= "Content-type: text/html\r\n"; 
$headers .= "Reply-To: avasquez@innovatechvs.com\r\n";
$headers .= "Bcc: avasquez@innovatechvs.com\r\n";		   
$mailbody ="
<h1 align='center'>Bavaro Adventure Park</h1>
<h3 align='center'>".mostrarFecha()."</h3>
<h3 align='center'>LLegadas del dia ".$dia_manana."</h3>
