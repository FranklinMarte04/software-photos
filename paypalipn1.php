...
/*Email de factura que se le envia al cliente*/
    $mailto ="'".$email_cl."',avasquez@innovatechvs.com,operaciones@bavaroadventurepark.com,asistconta3@bavaroadventurepark.com,phototeam@bavaroadventurepark.com";
