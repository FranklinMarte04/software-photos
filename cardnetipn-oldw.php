...
$tarjeta = $_POST['CreditCardNumber'];
...
/*Email de factura que se le envia al cliente*/
   ...
   $mailto ="".$email_cl.",avasquez@innovatechvs.com,operaciones@bavaroadventurepark.com,asistconta3@bavaroadventurepark.com,avictoria@bavaroadventurepark.com,directoroperaciones@bavaroadventurepark.com,gerenciafinanciera@bavaroadventurepark.com";
...
/*Email de factura que se le envia al cliente*/
   ...
   $mailto ="".$email_cl.",avasquez@innovatechvs.com,phototeam@bavaroadventurepark.com,asistconta3@bavaroadventurepark.com,gerenciafinanciera@bavaroadventurepark.com,asistconta5@bavaroadventurepark.com";
...
die();
   ...
   header("Location: http://www.bavaroadventurepark.com/view/pago_invalido");
