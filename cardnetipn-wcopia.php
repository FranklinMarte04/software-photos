...
if ($_POST) {
    ...
    $querylog="INSERT INTO log_carnet(logtext,fecha)VALUES('".print_r($_POST)."',NOW())";
    conectar($querylog);
...
WHERE vt.codigo_cliente='$transaccion'";
        ...
        $mailto = "" . $email_cl . ",operaciones@bavaroadventurepark.com,asistconta3@bavaroadventurepark.com,avasquez@innovatechvs.com,directoroperaciones@bavaroadventurepark.com,gerenciafinanciera@bavaroadventurepark.com,avictoria@bavaroadventurepark.com";
...
WHERE vt.codigo_cliente='$transaccion'";
        ...
        /* Email de factura que se le envia al cliente */
        $mailto = "" . $email_cl . ",avasquez@innovatechvs.com";
