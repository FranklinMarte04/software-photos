...
<!--[if gt IE 9]><!-->  <html> <!--<![endif]-->
 <head>
    ...
    <title>Payment - Bavaro Adventure Park</title>
...
<![endif]-->
  ...
  <div class="row">
    <div class="col-md-8">
      ...
      <div class="form_title">
        <h3><strong><i class="icon-ok"></i></strong>Conectado Con Sistema....</h3>
        

      </div>
      <div class="step">
        <p>
       Espere un momento para completar el pago...
             </p>
      </div><!--End step -->
  ...
  <!--Envia la informacion a Cardnet-->
