...
<head>
    ...
    <title>CD Photo- Bavaro Adventure Park</title>
   <?php echo $header; ?>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form method="post" name="frmcomprarphoto" action="<?php echo base_url(); ?>shopping_en/add_shopping_fotos">
					
          <div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<input name="nombre" id="nombre" type="text" placeholder="Enter your Name" class="form-control" value="<?php echo $this->session->userdata('datocliente')["nombre"]; ?>">
							</div>
						</div>
           ...
           <input name="fechaphoto" id="fechaphoto" readonly  class="form-control" type="text" value="<?php echo $this->session->userdata('datocliente')["fecha_visita"]; ?>">
							</div>
						</div>

            <div class="col-md-6">
                          <div class="form-group">
                            <input name="email" id="email" type="email" placeholder="Enter your E-Mail" class="form-control" value="<?php echo $this->session->userdata('datocliente')["email"]; ?>">
                          </div>
                        </div>
          ...
          <input name="referencia" id="referencia" type="text"  class="form-control" value="<?php echo $this->session->userdata('datocliente')["referencia"]; ?>">
            </div>
            </div>

				<div class="col-md-6">
			<textarea name="nota" id="nota" value="<?php echo $this->session->userdata('datocliente')["nota"]; ?>" class="form-control" style="height:100px" placeholder="Comments"><?php echo $this->session->userdata('datocliente')["nota"]; ?></textarea>
					</div>
            </div>
