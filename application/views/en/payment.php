	...
	<div class="row">
		<div class="col-md-8">
         ...
         <form method="post" id="form1">
			...
			<div class="form_title">
				<h3><strong>2</strong>Transportation</h3>
				<p>
					Our park offers transportation from various hotels in Bavaro / Punta Cana. We need to confirm the following information.
				</p>
			</div>
			<div class="step">
				<div class="row">
 ...
 $cantidad_nino=0;
	 ...
	 <aside class="col-md-4">
            <div class="box_style_1">
                ...
                <input class="btn_full" onclick="submitForm('<?php echo base_url(); ?>shopping_en/save_cardnet')" type="submit" value="Pay with Credit Card">
                <input class="btn_full" onclick="submitForm('<?php echo base_url(); ?>shopping/save_shopping')" type="submit" value="Pay with Paypal">
