...
<form style="display:none;" name='formTpv' method='post' action='https://www.sandbox.paypal.com/cgi-bin/webscr' style="border: 1px solid #CECECE;padding-left: 10px;">
          <input name="cmd" type="hidden" value="_cart"> 
          <input name="upload" type="hidden" value="1">
          <input name="business" type="hidden" value="hehotelpromotion@gmail.com">
          <input name="currency_code" type="hidden" value="USD">
  <input name="invoice" type="hidden" value="<?php echo $this->session->userdata('datofactura')["id_factura"]; ?>" >
          <input name="return" type="hidden" value="<?php echo base_url();?>shopping">
