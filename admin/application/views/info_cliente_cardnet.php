...
<div align="right">
 ...
 <thead>
                  ...
                  <tr>
                     ...
                     <th colspan="4">Datos Cuenta Cardnet</th>
                  ...
                  <tr>
                     ...
                     <td class="bold">Tarjeta Credito :</td>
                     ...
                     <td><?php echo $fila->creditcardnumber; ?></td>
                     ...
                     <td class="bold">Codigo respuesta:</td>
                     ...
                     <td><?php echo $fila->responsecode; ?></td>
                  ...
                  <tr>
                     ...
                     <td><?php echo date('d-m-Y H:m:s',  strtotime($fila->transaction_date)); ?></td>
                  ...
                  <td class="bold">Reference Number:</td>
                     ...
                     <td><?php echo $fila->retrievalreferencenumber; ?></td>
